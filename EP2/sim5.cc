...
int main(int argc, char *argv[]){
  ...
  */
  ...
  //Define o protocolo AODV como prioridade na lista de protocolos de roteamento para os roteadores 0 até 4
  //Define o protocolo RIP como prioridade na lista de protocolos de roteamento para os roteadores 5 até 8
  ...
  //Instala o protocolo de roteamento AODV nos roteadores
  for(int i = 0; i <= 4; i++){
  ...
  //channelLevel1.EnablePcapAll("sim5_channel1");
  //channelLevel2.EnablePcapAll("sim5_channel2");
  //channelLevel3.EnablePcapAll("sim5_channel3");
  //channelLevel4.EnablePcapAll("sim5_channel4");
  //channelLevel5.EnablePcapAll("sim5_channel5");

  //--------Animação do NetAnim--------

  //Gera xml para usar no NetAnim
  AnimationInterface anim ("sim5.xml");
